# Original Code: https://github.com/EdisonLeeeee/MaskGAE/tree/master/maskgae
...
# custom modules
from models.maskgae.loss import info_nce_loss, ce_loss, log_rank_loss, hinge_auc_loss, auc_loss
...
class GNNEncoder(nn.Module):
    ...
    def forward(self, x, edge_index):
        x = self.create_input_feat(x).float()
